...
Mobile.tap(findTestObject('Object Repository/Home_OneOfProduct - android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/DetProd_Button_Add to cart - android.widget.TextView - Add To Cart'), 0)

Mobile.tap(findTestObject('Object Repository/Header_Button_IconCart - android.widget.ImageView (1)'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Cart_Group_Product - android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('Object Repository/Cart_Button_RemoveItem - android.widget.TextView - Remove Item'), 0)

Mobile.tap(findTestObject('Object Repository/Cart_Text_No Items - android.widget.TextView - No Items'), 0)
