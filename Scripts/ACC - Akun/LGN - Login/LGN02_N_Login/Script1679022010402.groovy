...
Mobile.tap(findTestObject('Home_Button_Hamburger Menu - android.view.ViewGroup'), 0)
...
Mobile.verifyElementText(findTestObject('Object Repository/Login_ErrorMesssage - android.widget.TextView - Provided credentials do not match any user in this service'), 'Provided credentials do not match any user in this service.')
